...
import { getVendorData } from '../reducers/vendorProfile'
import './../assets/css/vendorProfile.css'

class VendorProfile extends Component {
  componentWillMount () {
    this.props.getVendorData(this.props.location.state.login)
  }
  render () {
      ...
      <div>
        <section className="login-block">
          <div className="container">
            <div className="row">
              {/* <div className="col-md-12 banner-sec-3 login-sec">
              </div> */}
              ...
              {/* <!-- Top navbar --> */}
                ...
                {/* <!-- Header --> */}
                <div className="header pb-8 pt-5 pt-lg-8 d-flex align-items-center" style={{"min-height": "600px", "background-image": "url(https://raw.githack.com/creativetimofficial/argon-dashboard/master/assets/img/theme/profile-cover.jpg)", "background-size": "cover", "background-position": "center top"}}>
                {/* <!-- Mask --> */}
...
const mapStateToProps = (state) => (state.vendorProfile)
const mapDispatchToProps = (dispatch) => bindActionCreators({ getVendorData }, dispatch)
